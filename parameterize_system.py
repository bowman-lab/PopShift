...
gb_setiadi_fstream = StringIO(
    ...
    <GBSA version="0.3" gb_model="OBC2" solvent_dielectric="78.5" solute_dielectric="1" sa_model="ACE" surface_area_penalty="5.4 * angstrom**-2 * mole**-1 * calorie" solvent_radius="1.4 * angstrom">
        ...
        <Atom smirks="[#1:1]" radius="7.068228303295e-02 * nanometer" scale="0.85"/>
        <Atom smirks="[#1:1]~[#7]" radius="1.218256113149e-01 * nanometer" scale="0.85"/>
        <Atom smirks="[#6:1]" radius="1.662784203155e-01 * nanometer" scale="0.72"/>
        <Atom smirks="[#7:1]" radius="5.327800106182e-02 * nanometer" scale="0.79"/>
        <Atom smirks="[#8:1]" radius="1.632214397109e-01 * nanometer" scale="0.85"/>
